...
JM的一些人员离开后，创立了自己的公司。JM通过3种手段来打击竞争对手：（1）起诉对方侵权，使其坐牢或者停止运营（例如，某人因此被判入狱）；（2）继续和对方做生意，了解对手，然后伺机瓦解对方的团队（例如，奇果）；（3）上门一哭二闹三上吊，干扰对方的正常运营（例如，迈思）。

## 1. JM喜欢探查员工的隐私，这来源于老板的喜好；  
JM通过技术手段监控员工的钉钉、微信、邮箱，所以员工不愿意在公司电脑登录任何个人账号。一旦你被公司发现和某些前员工保持私人联系，你也会因此受到严厉的处罚。

## 2. 没有高级管理团队，只有董事长和部门经理；  
...
## 7. JM总是处于动荡的状态中，使得公司处于一个非常诡异的状态；  
...
## 2. There is no senior management team, only the chairman and department managers;  
...
## 3. Those who have been resigned will be pulled back to continue working;  
...
## 4. Have a huge hardware team to complete continuous hardware cost down;  
...
## 6. There are more than 400 people, but there are few master degree engineers, and there is no investment in key technology;  
...
## 7. JM is always in a state of turmoil, which makes the company in a very strange state;
